        ...
        <b-overlay :show="game_in_progress.name" rounded="sm" variant="dark">
            ...
            <b-container fluid v-if="!showIntroPopup()" >
                ...
                <b-col cols="auto">
                    ...
                    <map name="image-map">
                        <area class="clicky" @click.prev="handleCityClick" id="intro-area" alt="Beginner's Park" title="Beginner's Park" coords="649,380,601,379,586,457,566,479,599,525,635,546,718,566,718,514" shape="poly">
                        <area class="clicky" @click.prev="handleCityClick" id="urban-area" alt="Urban Central" title="Urban Central" coords="650,3,671,141,585,221,643,354,724,509,801,437,829,221,779,9" shape="poly">
                        <area class="clicky" @click.prev="handleCityClick" id="wasteland-area" alt="Demolishing Wastelands" title="Demolishing Wastelands" coords="1,18,229,541" shape="rect">
                        <area class="clicky" @click.prev="handleCityClick" id="campandsnipe-area" alt="Campandsnipe" title="Campandsnipe" coords="295,158,254,198,232,302,255,366,270,502,351,525,446,508,562,473,595,384,641,331,578,229,404,294,332,226,323,187,348,149,326,143" shape="poly">
                        <area class="clicky" @click.prev="handleCityClick" id="championsian-area" alt="Championsian Federation" title="Championsian Federation" coords="401,92,334,176,405,285,579,217,668,125,637,4,469,21" shape="poly">
                    </map>
                ...
                <b-col md="3" class="dark-bg">
                    <b-row class="h-50">
                        <b-card header="City Info" bg-variant="dark">
                        <b-card-text>
