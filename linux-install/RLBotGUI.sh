...
then
    ...
    echo
    echo "Installing build-essential, python3.11-dev, python3.11-venv, python3-distutils..."
    echo
    sudo apt install build-essential python3.11-dev python3.11-venv python3-distutils
fi
